    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-md p-8 max-w-md w-full relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Faça login para gerenciar seus canais</p>
        </div>
        ...
        <div className="space-y-4">
          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-300 rounded-lg px-6 py-3 text-gray-700 hover:bg-gray-50 disabled:opacity-50 transition-colors"
          >
        ...
        {!import.meta.env.VITE_GOOGLE_CLIENT_ID && (
          <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-md">
            ...
            <p className="text-xs text-red-700">
              Adicione VITE_GOOGLE_CLIENT_ID no arquivo .env
            </p>
          </div>
        )}
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-md">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>• Adicione canais do YouTube</li>
